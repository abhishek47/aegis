...
@section('header')
	<section class="content-header">
	  <h1>
	    <span class="text-capitalize"><a href="/admin/problems-of-week/{{$problem->id}}"><i class="fa fa-angle-double-left"></i>  {{ $problem->main }}</a> | weekly-questions</span>
	    <small>{{ trans('backpack::crud.all') }} <span>{{ $crud->entity_name_plural }}</span> in {{ $problem->main }}.</small>
	  </h1>
	  <ol class="breadcrumb">
    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header {{ $crud->hasAccess('create')?'with-border':'' }}">
          ...
          <a class="btn btn-primary"  href="/admin/weekly-questions/create?problem={{$problem->id}}" data-toggle="tooltip" title="Add New chapter to problem"><i class="fa fa-plus"></i> Add Question</a>
