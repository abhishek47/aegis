...
@section('header')
	<section class="content-header">
	  <h1>
	    <span class="text-capitalize"><a href="/admin/quiz/{{$quiz->id}}"><i class="fa fa-angle-double-left"></i>  {{ $quiz->main }}</a> | Questions</span>
	    <small>{{ trans('backpack::crud.all') }} <span>{{ $crud->entity_name_plural }}</span> in {{ $quiz->main }}.</small>
	  </h1>
	  <ol class="breadcrumb">
    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header {{ $crud->hasAccess('create')?'with-border':'' }}">
          ...
          <a class="btn btn-primary"  href="/admin/questions/create?quiz={{$quiz->id}}" data-toggle="tooltip" title="Add New chapter to quiz"><i class="fa fa-plus"></i> Add Question</a>
