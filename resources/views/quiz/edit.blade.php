		  ...
		  <h3>Questions</h3>
		   <div class="box">
            ...
            <tbody>
                ...
                @foreach ($crud->entry->questions as $k => $question)
                <tr>
                    ...
                    <td>
                      <a class="btn btn-default btn-xs" href="/admin/questions/{{$question->id}}/edit">
                      <i class="fa fa-edit"></i> Edit</a>
                      <a class="btn btn-danger btn-xs" href="/admin/questions/{{$question->id}}" data-button-type="delete">
