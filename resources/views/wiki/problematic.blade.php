   ...
   <section class="inner-header divider " style="background-color: #24324a !important" >
      <div class="container pt-30 pb-30">
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              <h2 class="text-light font-36">Problematic Wikipages</h2>
              <ol class="breadcrumb text-left mt-10 white">
                <li><a href="#">Home</a></li>
                <li><a href="#">Wiki Pages</a></li>
                <li><a href="#">Problematic</a></li>
              </ol>
            </div>
          </div>
        </div>
...
<div style="background-color: #fafafa;min-height: 900px;">
  ...
  <div class="course-details clearfix p-10 pt-15">
                  ...
                  <div class="course-top-part pull-left mr-40">
                    <a href="#course-description" data-toggle="collapse"><h3 class="mt-0 mb-5"><b>What are Problematic Wikipages </b> <i class="fa fa-chevron-down"></i></h3></a>
                  </div>
      ...
      <div class="container">
           ...
           <div class="course-single-item bg-white border-1px clearfix mb-30 " style="width: 100%;cursor: pointer;" @click="openWiki({{ $wiki->id }})">
                 
                     <div class="course-details clearfix p-10 pt-15">
                      <div class="course-top-part pull-left mr-40">
                        <a href="/wiki/{{$wiki->id}}"><h4 class="mt-0 mb-5"><b>{{ $wiki->title }}</b></h4></a>
