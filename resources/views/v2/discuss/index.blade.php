...
<div style="height:0px;overflow:hidden">
 ...
 <div class="panel panel-default">
    <div class="panel-heading">
      <a class="panel-title text-dark" href="#new-post" data-toggle="collapse"  style="font-weight: bold;">Start New Discussion ( Put latex commands inside \$ \$ ) <i class="fa fa-chevron-down"></i></a>
    </div>
    <div class="panel-body collapse" id="new-post">
    <form method="POST" action="/discuss" class="text-dark">
      {{ csrf_field() }}
...
<i class="separator">|</i> 
  ...
  <div class="preview" id="marked-mathjax-preview-buffer2" 
	...
	<!-- <div>
		...
		<h2 class="title font-bold m-t-30">Recent Discussions</h2>
