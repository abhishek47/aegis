...
<section class="bg-light mini-spacer" style="min-height: 1000px;">
      ...
      <br>
	    <p class="font-bold">Solution : </p>
	     ...
	     <div class="editor--container hidden">
		  ...
		  <div class="preview font-18" id="marked-mathjax-preview"></div>
		  <div class="preview font-18" id="marked-mathjax-preview-buffer" 
		       style="display:none;
		              position:absolute; 
		              top:0; left: 0"></div>
	  </div>
	...
	<div class="page-header">
		<h5 class="font-bold m-t-30">Comments</h5>
	</div>
	...
	@foreach($question->comments as $comment)
       ...
       <div class="panel panel-default">
         ...
         <h3 class="panel-title text-dark" style="font-weight: bold;">{{ $comment->user->name }} | {{ $comment->created_at->diffForHumans() }}</h3>
          ...
          <a class="text-danger" href="/comment/{{$comment->id}}/like"><i class="fa fa-thumbs-up"></i> {{ $comment->likes }}</a> |  <a class="text-dark" href="/comment/{{$comment->id}}/dislike"><i class="fa fa-thumbs-down"></i> {{ $comment->dislikes }}</a> 
		  </div>
