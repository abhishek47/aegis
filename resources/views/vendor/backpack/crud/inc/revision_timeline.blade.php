    ...
    <div class="timeline-item">
      ...
      @else
        ...
        <div class="timeline-body p-b-0">
          ...
          <div class="row">
            <div class="col-md-6"><div class="well well-sm" style="overflow: hidden;white-space: pre-line;">{{ $history->oldValue() }}</div></div>
            <div class="col-md-6"><div class="well well-sm" style="overflow: hidden;white-space: pre-line;">{!! getRevisionedValue($history) !!}</div></div>
          </div>
        </div>
