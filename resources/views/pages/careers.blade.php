 ...
 <section class="inner-header divider layer-overlay overlay-theme-colored-7" data-bg-img="images/bg/bg1.jpg">
      <div class="container pt-120 pb-60">
        ...
        <div class="section-content">
          <div class="row"> 
            <div class="col-md-6">
              <h2 class="text-white font-36">Careers</h2>
   ...
   <section>
      <div class="container pt-0 mt-15">
        <div class="row">
          <div class="col-md-12">
            <div class="heading-line-bottom mt-0 mb-30">
              <h4 class="heading-title">Jobs List</h4>
            </div>
            <div class="icon-box mb-0 p-0">
              ...
              <a class="btn btn-dark btn-sm mt-15 ajaxload-popup" href="/ajax/apply-form.html">Apply Now</a>
            </div>
