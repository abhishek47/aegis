...
class ChapterNoteCrudController extends CrudController {
    ...
    public function create()
    {
        ...
        $this->data['post_url'] = 'chapter-notes';
    ...
    public function performSaveAction($itemId = null)
    {
        ...
        switch ($saveAction) {
            case 'save_and_new':
                $redirectUrl = 'admin/'. 'chapter-notes' . '/create?chapter='. $this->crud->entry->chapter->id;
                break;
            case 'save_and_edit':
                $redirectUrl = 'admin/chapter-notes'.'/'.$itemId.'/edit';
            ...
            case 'save_and_back':
            default:
                $redirectUrl = 'admin/'. 'chapter-notes' . '/chapter:' . $this->crud->entry->chapter->id;
                break;
        }
