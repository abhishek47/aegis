...
function addHeader2()
{
	insertAtCaret2('# Your Header');
}


function addLink2()
{
	insertAtCaret2("[Name your link](https://www.link.com)");
}

function addImage2()
{
	insertAtCaret2('![alt text](https://imagelink.com/icon48.png "Image Title")');
}

function addTable2()
{
	insertAtCaret2("| First Header  | Second Header |\n| ------------- | ------------- |\n| Content Cell  | Content Cell  |\n| Content Cell  | Content Cell  |\n ");
}

function addExample2()
{
	insertAtCaret2("<startexample>\r\n\r\n<endexample>");
		
}

function addBox2()
{
    insertAtCaret2("<startbox>\r\n\r\n<endbox>");
        
}

function addSoln2()
{
	insertAtCaret2("<startsolution>\r\n\r\n<endsolution>");
		
}

function addDef2()
{
	insertAtCaret2("<startdefinition>\r\n\r\n<enddefinition>");
		
}


function addTheorem2()
{
	insertAtCaret2("<starttheorem>\r\n\r\n<endtheorem>");
}


function addProof2()
{
	insertAtCaret2("<startproof>\r\n\r\n<endproof>");	
}
...
function addList2()
{
	insertAtCaret2("* Item 1\r\n* Item 2");
}	

function addNList2()
{
    insertAtCaret2("1. Item 1\r\n2. Item 2");
}   

function addCenterAlign2()
{
	insertAtCaret2("<startcenter>\r\n\r\n<endcenter>");
}	

function addQuestion2(id)
{
	insertAtCaret2('<startquestion-'+id+'></endquestion>');
}	


function addLine2(height)
{
    insertAtCaret2('<hr-'+height+'>')
...
function insertAtCaret2(text) {
	    ...
	    var areaId = 'marked-mathjax-input2';
